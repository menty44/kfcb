    ...
    <div class="row bs-reset">
        <div class="col-md-6 bs-reset">
            <div class="login-bg" style="background-image:url('{{asset("/assets/pages/img/login/bg1.jpg")}}')">
                <!-- <img class="login-logo" src="{{asset('/assets/pages/img/login/')}}" /> --> </div>
        </div>
        <div class="col-md-6 login-container bs-reset">
            <div class="login-content">
                ...
                <form class="form-horizontal login-form" role="form" method="POST" action="{{ url('/login') }}">
                    ...
                    <div class="row">
                        <div class="col-xs-6 {{ $errors->has('email') ? ' has-error' : '' }}">
                            <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="User Email" name="email" required/> </div>
                ...
                <legend></legend>
                <fieldset>
                    <legend><h4 class="font-green">New User ? &nbsp&nbsp&nbsp&nbsp
                            <a href="{{url('/register')}}">Create An Account</a></h4>
                    </legend></fieldset>
                </p></p></p></p>
                <!-- END SIGNUP -->
