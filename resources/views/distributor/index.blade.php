...
<head>
    <title>KFCB - Distributor Application</title>
...
<div class="container-fluid menu-hidden sidebar-hidden-phone fixed menu-left">
    ...
    <div id="content">
        ...
        <ul class="breadcrumb">
            ...
            <li>Distributor License Application</li>

        </ul>

        <h2>Distributor License Application</h2>
        <div class="innerLR">
            ...
            <!-- Form -->
            <form class="form-horizontal margin-none" id="validateSubmitForm" method="POST" action="{{ url('/distributor') }}" autocomplete="off">
                {{ csrf_field() }}
                        <!-- Widget -->
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span12">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="companyname" name="companyname" type="text" value="{{ old('companyname') }}" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="telephone" name="address" type="text" value="{{ old('address') }}" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="telephone" name="telephone" type="text" value="{{ old('telephone') }}"  />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="Director1" name="director1" type="text" value="{{ old('director1') }}" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="Director2" name="director2" type="text" value="{{ old('director2') }}" />
                                        @if ($errors->has('director2'))
                                            <span class="help-block">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="Director1" name="director3" type="text" value="{{ old('director3') }}"/>
                                        @if ($errors->has('director3'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('director3') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <div class="controls">
                                            <input class="span12" id="Director1" name="director4" type="text" value="{{ old('director4') }}" />
                                            @if ($errors->has('director4'))
                                                <span class="help-block">
                                                <strong>{{ $errors->first('director4') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="selectpicker span12" name="town" data-style="btn-primary" value="{{ old('town') }}">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="plot" name="plot" type="text" value="{{ old('plot') }}" />
                                    </div>
                                </div>
                                <!-- // Group END -->
                                ...
                                <!-- Group -->
                                <div class="control-group">
                                    <label class="control-label" for="employees">No. of EMployees</label>
                                    <div class="controls">
                                        <input class="span12" id="employees" name="employees" type="text" value="{{ old('employees') }}"/>
                                ...
                                <!-- Group -->
                                <div>
                                    <strong>Enter Sources of your Media</strong></br>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="source">Tapes, DVDs &amp; VCDs</label>
                                    <div class="controls">
                                        <input class="span12" id="source" name="source" type="text" value="{{ old('source') }}"/>
                                ...
                                <!-- Group -->
                                <div><strong>Do you operate another video library elsewhere? If yes, state area and plot</strong></br></div>
                                <div class="control-group">
                                    <label class="control-label" for="source1">source1 of Tapes, DVDs &amp; VCDs</label>
                                    <div class="controls">
                                        <input class="span12" id="source1" name="source1" type="text" value="{{ old('source1') }}" />
                                        @if ($errors->has('filmtitle'))
                                            <span class="help-block">
                                            <strong>{{ $errors->first('source1') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <!-- Group -->
                                <div class="control-group">
                                    <label class="control-label" for="town2">Town/Area</label>
                                    <div class="controls">
                                        <select class="selectpicker span12" data-style="btn-primary" name="town2" value="{{ old('town2') }}">
                                            <option>Baragoi</option>
                                            <option>Bungoma</option>
                                            <option>Busia</option>
                                            <option>Butere</option>
                                        ...
                                        @if ($errors->has('town2'))
                                            <span class="help-block">
                                            <strong>{{ $errors->first('town2') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                ...
                                <!-- Group -->
                                <div class="control-group">
                                    <label class="control-label" for="plot2">Plot No</label>
                                    <div class="controls">
                                        <input class="span12" id="plot2" name="plot2" type="text" value="{{ old('plot2') }}"/>
                                        @if ($errors->has('filmtitle'))
                                            <span class="help-block">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="police" name="police" type="text" value="{{ old('police') }}" />
                                        @if ($errors->has('police'))
                                            <span class="help-block">
                                            <strong>{{ $errors->first('police') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="chiefs" name="chiefs" type="text" value="{{ old('chiefs') }}" />
                                        @if ($errors->has('chiefs'))
                                            <span class="help-block">
                                            <strong>{{ $errors->first('chiefs') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span12" id="countyoffice" name="countyoffice" type="text" value="{{ old('countyoffice') }}"/>
                                        @if ($errors->has('countyoffice'))
                                            <span class="help-block">
                                            <strong>{{ $errors->first('countyoffice') }}</strong>
                                        </span>
                                        @endif
                                    </div>
                                </div>
