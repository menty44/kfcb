            ...
            <div class="innerAll shop-client-products cart invoice">
                ...
                <table class="table table-bordered table-primary table-striped table-vertical-center">
                    ...
                    <tr>
                        ...
                        <td>
                            <h5>{{$dist->filmtitle}}</h5>
                            <span class="label">{{$dist->filmtitle}}</span>
                        </td>
                        <td class="center">1</td>
                        <td class="center">{{$dist->fee}}</td>
                        <td class="center">1.60</td>
                        <td class="center">{{($dist->fee)*(1.6)}}</td>
                    </tr>
                    <!-- // Cart item END -->
                    <!-- Cart item -->
                    </tbody>
                    ...
                    <div class="span4 offset3">
                        <table class="table table-borderless table-condensed cart_total">
                            ...
                            <tr>
                                ...
                                <td class="right strong">{{($dist->fee)*(1.6)}}.00</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="right strong">KES {{($dist->fee)*(1.6)+5}}.00</td>
                            </tr>
