            ...
            <div class="innerAll shop-client-products cart invoice">
                ...
                <table class="table table-bordered table-primary table-striped table-vertical-center">
                    ...
                    <tr>
                        ...
                        <td>
                            <h5>Classification Certificate</h5>
                            <span class="label">Nairobi Half Life</span>
                        </td>
                        <td class="center">1</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <h5>Video Exhibition License</h5>
                            <span class="label">20th Century IMAX</span>
                        </td>
                        <td class="center">1</td>
                        <td class="center">100,000</td>
                        <td class="center">16,000</td>
                        <td class="center">116,000</td>
                    </tr>
